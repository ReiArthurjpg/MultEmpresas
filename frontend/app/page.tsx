...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#05070A] text-white font-sans selection:bg-[#0EA5E9] selection:text-white flex overflow-hidden relative">
      <div className="w-full lg:w-[45%] flex flex-col relative z-10 bg-[#05070A] border-r border-white/5 shadow-2xl">
          ...
          <div className="w-full max-w-md">
            <div className="mb-8">
              <h1 className="text-4xl font-black italic uppercase tracking-tighter mb-2">
                ACESSE SUA <span className="text-[#0EA5E9]">CONTA</span>
              </h1>
              ...
              <div className="flex gap-4 mt-5 opacity-85">
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-tighter text-slate-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#0EA5E9] animate-pulse" /> Verytas Ativo
                </div>
              </div>
            </div>
        ...
        <footer className="p-8 flex justify-center gap-8 opacity-40 text-[9px] font-black uppercase tracking-widest border-t border-white/5">
          <a href="#" className="hover:text-[#0EA5E9] transition-colors">Política de Privacidade</a>
          <a href="#" className="hover:text-[#0EA5E9] transition-colors">Suporte Tecnológico</a>
          <a href="#" className="hover:text-[#0EA5E9] transition-colors">Termos de Segurança</a>
        </footer>
      </div>

      <div className="hidden lg:flex lg:w-[55%] flex-col relative overflow-hidden bg-gradient-to-br from-[#040609] via-[#080B11] to-[#0ea5e9]/10 p-16 justify-center items-center">
        <div className="absolute top-1/2 left-1/2 w-[550px] h-[550px] bg-[#0ea5e9]/15 blur-[160px] rounded-full -translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <div className="relative z-10 text-center max-w-lg flex flex-col items-center">
          <div className="relative mb-10 group select-none">
            <div className="absolute inset-0 bg-[#0ea5e9] rounded-2xl blur-3xl opacity-20 group-hover:opacity-35 transition-opacity duration-700 animate-pulse" />
            <div className="relative bg-[#090D15]/80 border border-white/10 p-10 py-12 rounded-2xl backdrop-blur-xl flex flex-col items-center justify-center shadow-2xl w-80 -skew-x-3 hover:scale-105 hover:border-[#0ea5e9]/40 transition-all duration-500">
              <span className="text-[10px] font-black text-[#0ea5e9] tracking-[0.4em] uppercase mb-3">TECNOLOGIA</span>
          ...
          <h2 className="text-5xl font-black uppercase italic tracking-tighter leading-none mb-4 text-center">INTELIGÊNCIA EM <span className="text-[#0ea5e9] drop-shadow-[0_0_20px_rgba(14,165,233,0.4)]">DADOS</span></h2>
          <div className="h-[2px] w-16 bg-[#0ea5e9] mb-6 rounded-full" />
